                                        ...
                                        if (i === 0) {
                                            ...
                                            elements.push(
                                                <div key="welcome-block" className="mb-4">
                                                    {/* Big red welcome */}
                                                    <p className="text-red-500 font-display font-black text-3xl uppercase leading-tight mb-3 drop-shadow-[0_0_20px_rgba(239,68,68,0.6)]">
                                                        {headline}
                                                    </p>
                                                    {/* Body text */}
                                        ...
                                        if (trimmed === 'OUR PHILOSOPHY IS SIMPLE:') {
                                            ...
                                            elements.push(
                                                <div key={`philosophy-${i}`} className="flex flex-col flex-1">
                                                    <p className="text-white font-black text-[18px] mb-4 tracking-wide uppercase border-l-4 border-white pl-3 bg-white/5 py-1 rounded-r" style={{ textShadow: '0 0 10px rgba(255,255,255,0.4)' }}>
                                                    ...
                                                    <ul className="flex flex-col gap-5 flex-1">
                                                        {pillars.map((p, pIdx) => {
                                                            ...
                                                            return (
                                                                <li key={pIdx} className="flex items-start gap-3 text-[14px] leading-relaxed border-l-2 border-white/20 pl-4 py-1">
